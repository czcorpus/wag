...
export const deprelValues: Array<DeprelValue> = [
    [
        'acl',
        'přívlastek jako finitní i nefinitní klauze, nevazebný dopolněk',
        'Mám dojem, že bych nepřepral ani hraboše. Nikdy jsem ji neviděl naštvanou.',
    ],
    ['acl:relcl', 'vztažná věta', 'Nevěří tomu, co vidí.'],
    ['advcl', 'vedlejší věta příslovečná', 'Spěchal, aby přišel včas.'],
    [
        'advmod',
        'adverbiální příslovečné určení',
        'geneticky upravené potraviny',
    ],
    [
        'advmod:emph',
        'zdůrazňovací slovo, intensifikátor',
        'Trvalo to sotva pár vteřin.',
    ],
    [
        'amod',
        'adjektivní (shodný) přívlastek',
        'Václav si vzal třímilionovou půjčku.',
    ],
    ...
    [
        ...
        'Výstrahy byly bohužel oslyšeny.',
    ],
    ['case', 'předložka', 'Bydlím na samotě.'],
    ['cc', 'souřadicí spojka', 'Je to mladý a nadějný chlapík.'],
    [
        'ccomp',
        'obligatorní větné doplnění',
        'Ještě včera hlásili, že pršet nebude.',
    ],
    ['clf', 'klasifikátor', '三个学生 sān gè xuéshēng'],
    [
        'compound',
        'nefinální části složené číslovky',
        'Bude to stát padesát pět tisíc korun.',
    ],
    [
        'conj',
        'další člen koordinace',
        'Teta včera večer přijela, přespala a ráno zase odjela.',
    ],
    ...
    [
        'det:numgov',
        'zájmenná číslovka v neshodném pádu)',
        'Mimoto bylo nablízku několik dalších králíků.',
    ],
    [
        'det:nummod',
        'zájmenná číslovka ve shodném pádu',
        'V městě se na mnoha místech objevily plameny.',
    ],
    ['discourse', 'diskursní výraz', 'čemu že se to zpronevěřily'],
    ['dislocated', 'extrapozice', 'Dumplings I like.'],
    [
        'expl:pass',
        'zvratné zájmeno ve zvratném pasivu',
        'S tím se nedalo nic dělat.',
    ],
    [
        'expl:pv',
        'zvratná částice u reflexiva tantum',
        'Ona se občas tak legračně dívá.',
    ],
    [
        'fixed',
        'další části víceslovného výrazu',
        've srovnání například s úvěry',
    ],
    [
        'flat',
        'další části označení osoby',
        'Nejlépe to vyjádřil papež Jan Pavel II.',
    ],
    [
        'flat:foreign',
        'další části cizího víceslovného výrazu',
        'Summum ius, summa iniuria je estetická maxima.',
    ],
    [
        'goeswith',
        'další část chybně rozděleného tvaru',
        'Zastavil se a z těžka oddychoval.',
    ],
    ...
    [
        'nsubj:pass',
        'podmět věty se slovesem v trpném rodě',
        'Vypnutí vysílačky se trestá.',
    ],
    ['nummod', 'číslovka', 'Jedno kotě spalo.'],
    [
        'nummod:gov',
        'číslovka v pádu neshodném se jménem',
    ...
    [
        'obl:arg',
        'předmět v nepřímém pádu nebo přísl. určení ve funkci argumentu',
        'Otec určitě myslel jen na matku. Věnoval jí knížku.',
    ],
    [
        'orphan',
        'závislost na vypuštěném větném členu',
        'Pavel si objednal špenát a Markéta brokolici.',
    ],
    [
        'parataxis',
        'vsuvka, uvozovací věta',
    ...
    [
        'xcomp',
        'adjektivum nebo sloveso jako obligatorní doplnění s nevyjádřeným podmětem',
        'Doktorka mi doporučila denně cvičit.',
    ],
];

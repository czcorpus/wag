    ...
    constructor({tileId, dispatcher, appServices, ut, mainForm, widthFract, conf}:TileFactory.Args<ConcordanceTileConf>) {
        ...
        this.model = new ConcordanceTileModel({
            ...
            initState: {
                ...
                kwicLeftCtx: ConcordanceTileModel.CTX_SIZES[widthFract] || ConcordanceTileModel.CTX_SIZES[0],
                kwicRightCtx: ConcordanceTileModel.CTX_SIZES[widthFract] || ConcordanceTileModel.CTX_SIZES[0],

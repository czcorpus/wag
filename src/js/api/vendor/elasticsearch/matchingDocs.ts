...
export class ElasticsearchMatchingDocsAPI
    implements MatchingDocsAPI<ElasticsearchQueryArgs>
{
    ...
    stateToArgs(
        state: MatchingDocsModelState,
        query: string
    ): ElasticsearchQueryArgs {
        return {
            q: state.searchAttrs
    ...
    call(
        ...
        tileId: number,
        queryIdx: number,
        args: ElasticsearchQueryArgs
    ): Observable<APIResponse> {
        return ajax$<HTTPResponse>('GET', this.apiURL, args, {

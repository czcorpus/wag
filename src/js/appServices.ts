...
export interface AppServicesArgs {
  ...
  apiReportingHeaders: HTTPHeaders;
...
export class AppServices implements IAppServices {
  ...
  private readonly apiReportingHeaders: HTTPHeaders;
  ...
  constructor({
    ...
    this.apiReportingHeaders = apiReportingHeaders;
  }
  ...
  getApiReportingHeaders(): HTTPHeaders {
    return this.apiReportingHeaders;
  }
}
